const styles = {
  ...
  heroSubText:
    "text-[#8BA8A0] font-medium lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[14px] lg:leading-[40px]",

  sectionHeadText:
    "text-white font-black md:text-[60px] sm:text-[50px] xs:text-[40px] text-[28px]",
  sectionSubText:
    "sm:text-[18px] text-[13px] text-secondary uppercase tracking-wider",
};
